...
class TaskUpdateServiceTest {
    ...
    void updateTask() throws TaskSQLCustomException {
        ...
        when(taskRepository.updateTask(expectedTask))
                .thenReturn(expectedTask);

        Task task = taskUpdateService.updateTask(expectedTask);

        assertUpdateTask(expectedTask, task);

    }

    private static void assertUpdateTask(Task expectedTask, Task task) {
